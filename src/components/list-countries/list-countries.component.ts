...
export class ListCountriesComponent implements OnInit {
    ...
    public dummyDTOs: { name: string; code: string; emoji: string; unicode: string; image: string }[];
    ...
    private findAll(): void {
        //dummy data for now
        // Your component or service file

        // this.countryDTOs = [
        //     { id: 1, name: 'USA', currency: 'US Dollars' },
        //     { id: 2, name: 'India', currency: 'Indian Rupee' },
        //     { id: 3, name: 'Canada', currency: 'Canadian Dollar' },
        //     { id: 4, name: 'Germany', currency: 'Euro' },
        //     { id: 5, name: 'Australia', currency: 'Australian Dollar' },
        //     { id: 6, name: 'Japan', currency: 'Japanese Yen' },
        //     { id: 7, name: 'Brazil', currency: 'Brazilian Real' },
        //     { id: 8, name: 'South Africa', currency: 'South African Rand' },
        //     { id: 9, name: 'Mexico', currency: 'Mexican Peso' },
        //     { id: 10, name: 'China', currency: 'Chinese Yuan' },
        //     { id: 11, name: 'United Kingdom', currency: 'British Pound' },
        //     { id: 12, name: 'France', currency: 'Euro' },
        //     { id: 13, name: 'Italy', currency: 'Euro' },
        //     { id: 14, name: 'Spain', currency: 'Euro' },
        //     { id: 15, name: 'Russia', currency: 'Russian Ruble' },
        // ];
    ...
    private parseDummyJson(): void {
        this.countryDTOs = this.dummyDTOs.map((jsonItem, index) => {
            const countryDTO = new CountryDTO();
            countryDTO.id = index + 1; // Assigning the index as ID
            countryDTO.name = jsonItem.name;
            countryDTO.currency = jsonItem.code;
            countryDTO.flagUrl = jsonItem.image;
